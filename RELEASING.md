...
4. Run `npm run check`.
5. Review `npm pack --dry-run --json` and confirm that no tests, CI files, scripts, backups, credentials, or generated archives are included.
6. Commit only when explicitly authorized. Do not publish, tag, or push as part of local validation.
